// Under runtime/debug package function GCStats collects information about recent garbage collections.
//And PrintStack prints to standard error the stack trace returned by runtime.Stack.
package main
